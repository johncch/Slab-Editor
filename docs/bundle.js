...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatter__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__keymap__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__renderer__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selection__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__style__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__textruler__ = __webpack_require__(11);
...
class SlabEditor {
    constructor(element, options) {
        this.id = __WEBPACK_IMPORTED_MODULE_8__utils__["a" /* generateId */]();
        // Mouse methods
        this.cursorTimeout = -1;
        // Keyboard shortcut methods
        this.commandTriggered = false;
        this.lineStatCache = new Map();
        this.canvas = element;
        this.canvas.setAttribute("tabIndex", "0");
        this.canvas.style.position = "relative";
        this.canvas.style.userSelect = "none";
        this.canvas.innerHTML = "";
        this.style = new __WEBPACK_IMPORTED_MODULE_6__style__["a" /* Style */](element);
        this.setupElements();
        this.attachEventHandlers();
        options = options || {};
        this.keymap = options.keymap || __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__keymap__["a" /* defaultKeyMap */])();
    ...
    load(text = "") {
        ...
        this.formatter = new __WEBPACK_IMPORTED_MODULE_2__formatter__["a" /* PlainTextFormatter */]();
        this.renderer = new __WEBPACK_IMPORTED_MODULE_4__renderer__["a" /* PlainTextRenderer */](this.textRuler);
        this.renderDocument();
    ...
    setupElements() {
        ...
        this.textRuler = new __WEBPACK_IMPORTED_MODULE_7__textruler__["a" /* TextRuler */]();
        ...
        this.cursor.focus();
        this.selection = new __WEBPACK_IMPORTED_MODULE_5__selection__["a" /* Selection */]();
    }
    attachEventHandlers() {
    ...
    handleCanvasClick(e) {
        __WEBPACK_IMPORTED_MODULE_8__utils__["b" /* log */]("[click]");
    }
    handleCanvasDblClick(e) {
        __WEBPACK_IMPORTED_MODULE_8__utils__["b" /* log */]("[double click]");
        e.preventDefault();
        e.stopPropagation();
    ...
    handleCanvasMouseDown(e) {
        __WEBPACK_IMPORTED_MODULE_8__utils__["b" /* log */]("[mouse down]");
    ...
    handleCanvasMouseUp(e) {
        __WEBPACK_IMPORTED_MODULE_8__utils__["b" /* log */]("[mouse up]");
        const coords = this.normalizeMouseCoordinates(e);
        const pos = this.locate(coords.x, coords.y);
    ...
    handleKeyPress(e) {
        ...
        if (target instanceof HTMLTextAreaElement) {
            __WEBPACK_IMPORTED_MODULE_8__utils__["b" /* log */](`[keypress] ${this.cursor.textarea.value}`);
    ...
    handleDocObjChange(e) {
        ...
        switch (e.type) {
            case __WEBPACK_IMPORTED_MODULE_1__document__["b" /* ChangeType */].Insert:
                this.update(e.line);
                changeMarker = new __WEBPACK_IMPORTED_MODULE_5__selection__["b" /* Marker */](e.line, e.col);
    ...
    createLineItem() {
        ...
        lineItem.setAttribute("id", `list-item$${__WEBPACK_IMPORTED_MODULE_8__utils__["a" /* generateId */]()}`);
    ...
    createRowItem() {
        ...
        lineItem.setAttribute("id", `row-item$${__WEBPACK_IMPORTED_MODULE_8__utils__["a" /* generateId */]()}`);
        lineItem.style.minHeight = `${this.style.lineHeight}px`;
        return lineItem;
    }
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PlainTextFormatter;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PlainTextRenderer;
